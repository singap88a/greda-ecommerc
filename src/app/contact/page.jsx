...
const Page = () => {
  ...
  return (
    ...
    <div className="text-rols">
      <h3>تواصل معنا</h3>
      <span> <a href="/" className="home-hover">     Home</a>   /      بيانات التواصل </span>
    </div>
  </div>


<div className="cont_form-contact">
  ...
  <div style={{ justifyContent:"space-between",gap:"2rem" }} className="flex form-class">
